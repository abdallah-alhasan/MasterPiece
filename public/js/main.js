...
const tradesDiv = document.getElementsByClassName('trades-div')[0]
const closeTradesDiv = document.getElementById('close')
const requestButton = document.getElementById('trade-button')

const showTrades = () => {
	tradesDiv.classList.add('show__form')
}
const hideTradeDiv = () => {
	tradesDiv.classList.remove('show__form')
}

closeTradesDiv.addEventListener('click', hideTradeDiv)
requestButton.addEventListener('click', showTrades)