                    ...
                    <div class="sign__content">
                        ...
                        <form method="POST" action="{{ route('login') }}"  class="sign__form">
                            ...
                            <div class="sign__group">
                                <input type="text" class="sign__input" placeholder="Email" id="email"  type="email" name="email" value="{{old('email')}}" required autofocus>
                            </div>
    
                            <div class="sign__group">
                                <input type="password" class="sign__input" placeholder="Password" id="password"  type="password" name="password" required autocomplete="current-password">
                            </div>
                            ...
                            <span class="sign__text">Don't have an account? <a href="{{route('register')}}">Register!</a></span>
