...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="sidebar">
                <div class="widget price text-center mb-0">
                    <h4>Price</h4>
                    <p>$230</p>
                </div>
                <!-- User Profile widget -->
                <div class="widget user">
                    <img class="mb-3" src="images/user/user-thumb.jpg" alt="" style="width:100%">
                ...
                <!-- Map Widget -->
                <div class="widget map p-0">
                            <div class="mapouter" style="width:100%; height:100%"><div class="gmap_canvas"><iframe style="width: 100%;
                                height: 300px;" id="gmap_canvas" src="https://maps.google.com/maps?q=2880%20Broadway,%20New%20York&t=k&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div></div>
                </div>
                <!-- Rate Widget -->
