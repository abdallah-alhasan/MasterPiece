				...
				<div class="row">
					<div class="col-12">
						<div class="section__wrap">
							<!-- section title -->
							<h2 class="section__title">Trades</h2>
							<!-- end section title -->
				...
				<div class="row">
                    <div class="col-12 col-md-7 col-xl-8">
                        <div class="row">
							...
							<!-- section title -->
							<div class="col-12">
								<h2 class="section__title">Add a trade</h2>
							</div>
							<!-- end section title -->
	
							<div class="col-12">
								<form action="{{route('trade.store')}}" method="POST" class="form form--contacts" enctype="multipart/form-data">
                                    @csrf
                                    <div>
                                        <label for="title" class="form__label">Game title</label>
                                        <input type="text" class="form__input" name="title" id="title" placeholder="Title" value="{{old('title') ?? ''}}">
                                        @error('title')
                                    ...
                                    <div>
                                        <label for="image" class="form__label">Game image</label>
                                        <input type="file" class="form__input" name='image' id="image" value="{{old('image') ?? ''}}">
                                        @error('image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div>
                                        ...
                                        <select name="platform_id" class="form__select" id="platform" value="{{old('platform_id') ?? ''}}">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="form__input" name="tags" placeholder="Add your game tags e.g (Adventure, Action, Fantsy)" id="tags" value="{{old('tags') ?? ''}}">
                                        @error('tags')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
